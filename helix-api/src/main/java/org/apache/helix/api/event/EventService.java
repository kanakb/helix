...
public interface EventService {
  ...
  boolean subscribe(Class<? extends HelixEvent> eventType, EventFilter filter, EventSubscriber subscriber);
  
  boolean unsubscribe(Class<? extends HelixEvent> eventType, EventFilter filter, EventSubscriber subscriber);
