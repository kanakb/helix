...
public class TestDistControllerElection extends ZkUnitTestBase {
  ...
  public void testController() throws Exception {
    ...
    HelixManager manager =
        new MockZKHelixManager(clusterName, controllerName, MemberType.CONTROLLER, _gZkClient);
    ...
    manager =
        new MockZKHelixManager(clusterName, "controller_1", MemberType.CONTROLLER, _gZkClient);
  ...
  public void testControllerParticipant() throws Exception {
    ...
    final String controllerName = "controller_0";
    HelixManager manager =
        new MockZKHelixManager(clusterName, controllerName, MemberType.CONTROLLER_PARTICIPANT,
            _gZkClient);
    ...
    manager =
        new MockZKHelixManager(clusterName, "controller_1", MemberType.CONTROLLER_PARTICIPANT,
            _gZkClient);
    election = new DistClusterControllerElection(ZK_ADDR);
    context = new NotificationContext(manager);
    context.setType(NotificationContext.Type.CALLBACK);
  ...
  public void testParticipant() throws Exception {
    ...
    HelixManager manager =
        new MockZKHelixManager(clusterName, controllerName, MemberType.PARTICIPANT, _gZkClient);
