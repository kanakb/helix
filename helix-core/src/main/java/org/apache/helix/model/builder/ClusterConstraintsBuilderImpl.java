...
public class ClusterConstraintsBuilderImpl extends ClusterConstraintsBuilder{
  ...
  public ClusterConstraintsBuilderImpl(){
    
  }
  
  public ClusterConstraintsBuilder withType(ConstraintType type) {
    if (type == null) {
